...
define config.name = _("Jamie And Marley Die A Lot")
...
define config.main_menu_music = "menu music.mp3"
...
define config.save_directory = "HorrorV-1510798242"
