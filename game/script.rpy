...
label start:
   ...
   # TODO: This shouldn't be necessary once we have the CG in place, I think
   hide v
   hide n
   hide l
   hide c
   ...
   "The chatter in the room starts up again, but I can barely hear it. His eyes skim the room before they stop to look at--me?"
   
   "He doesn’t meet my glance though. His eyes flicker once to the other side of the room--to Liam?--before he moves forward past the lines of desks. He sits down, on the third seat in the middle column of chairs and takes out his books."
   ...
   show sf normal at center # should be "flying through the window"

   "A crane appears, gracefully gliding through an open window to rest by Shouhei’s desk. A physical familiar. The whispers around me get louder. Physical familiars are not unknown, but they're rarer now than they once were."
   ...
   show TKbracelet at center # (do we neeed a character for this or can we just show random images too?)
   ...
   hide TKbracelet
   show vf phone at right

   vf "It’s lunchtime! Where are you going to go now?" 

   "Most of the class has filed out already. Nora waved cheerfully to me as she left, Liam had dashed off to his after-class job. Connor looked like he was heading back to his room. Shouhei had left too, his familiar gliding behind him."

   v "I think I’ll go eat lunch at:"
